    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <form role="form" action="<?= base_url; ?>/mahasiswa/updateMahasiswa" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="mahasiswaID" value="<?= $data['mahasiswa']['MahasiswaID']; ?>">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="masukkan tanggal lahir mahasiswa..." name="tanggal_lahir" value="<?= $data['mahasiswa']['TanggalLahir']; ?>">
                    </div>
                    <div class="form-group">
                        <label>Kontak Darurat</label>
                        <input type="text" class="form-control" placeholder="masukkan tanggal lahir mahasiswa..." name="kontak_darurat" value="<?= $data['mahasiswa']['KontakDarurat']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="programstudiID">
                            ...
                            <?php foreach ($data['program_studi'] as $row) : ?>
                                <option value="<?= $row['ProgramStudiID']; ?>" <?php if ($data['mahasiswa']['ProgramStudiID'] == $row['ProgramStudiID']) echo 'selected'; ?>>
                                    <?= $row['NamaProgram']; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
